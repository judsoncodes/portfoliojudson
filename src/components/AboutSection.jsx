  ...
  return (
    <div className="legend-sub-root">
      ...
      <div className="periscope">
        ...
        {/* Abyssal Heart Radar Blip (More subtle and timed) */}
        <div className="absolute top-[65%] left-[30%] w-1 h-1 rounded-full z-10 abyssal-blip" />

        {/* Default Scanning Text */}
        <div className="scanning-text-layer" style={{
        ...
        {/* Timed Discovery Text */}
        <div className="abyssal-blip-text" style={{
          position: 'absolute', top: '50%', left: '50%',
          transform: 'translate(-50%, -50%)',
          fontFamily: 'monospace', fontSize: '8px',
          textAlign: 'center', width: '100%', zIndex: 10
        }}>
          HEART_FOUND<br/>
          [0,-14,-65]
        </div>
      ...
      <div className="crystal-card">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center md:items-start mt-6 md:mt-10">
          
          {/* PERSONNEL IDENTIFICATION PANEL */}
          <div className="w-full max-w-[280px] md:max-w-[320px] shrink-0 relative group">
            {/* TACTICAL FRAME */}
            <div className="relative w-full aspect-[3/4] rounded-2xl border-2 border-white/10 bg-black/60 p-2 overflow-hidden backdrop-blur-xl transition-all duration-500 group-hover:border-cyan-400/40">
               {/* SCANNING LASER EFFECT */}
               <div className="absolute top-0 left-0 w-full h-[2px] bg-cyan-400/40 blur-sm animate-[scanLine_4s_linear_infinite] z-20" />
               
               {/* THE IMAGE */}
               <div className="w-full h-full rounded-xl overflow-hidden relative bg-cyan-900/20">
                  <div 
                    ...
                    style={{ 
                      backgroundImage: 'url("/profile.jpg.jpeg")',
               ...
               {/* CORNER ACCENTS */}
               <div className="absolute top-0 left-0 w-6 h-6 md:w-8 md:h-8 border-t-2 border-l-2 border-cyan-400/30 rounded-tl-2xl" />
               <div className="absolute bottom-0 right-0 w-6 h-6 md:w-8 md:h-8 border-b-2 border-r-2 border-cyan-400/30 rounded-br-2xl" />
            </div>

            {/* EXTERNAL LABELS - Hidden on very small screens to save space */}
            <div className="hidden sm:block absolute -left-6 top-1/2 -rotate-90 origin-center font-mono text-[7px] md:text-[9px] text-cyan-400/20 uppercase tracking-[0.5em] md:tracking-[1em] whitespace-nowrap">
              Biometric_Verification_System
            </div>
          </div>

          {/* MISSION OBJECTIVES / NARRATIVE */}
          <div className="w-full flex-1 space-y-6 md:space-y-8 text-center md:text-left">
            <div className="space-y-2">
              <div className="font-mono text-[8px] md:text-[10px] text-cyan-500/40 tracking-[0.4em] md:tracking-[0.6em] uppercase">// LOG_ENTRY_ALPHA</div>
            ...
            <p className="font-mono text-[10px] md:text-base text-white/70 leading-relaxed border-l-0 md:border-l-2 border-cyan-400/20 md:pl-6 py-2">
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 gap-3 md:gap-8 pt-2">
               <div className="p-3 md:p-4 border border-white/5 bg-white/5 rounded-xl backdrop-blur-sm">
                  <div className="font-mono text-[6px] md:text-[8px] text-cyan-500/60 uppercase mb-1 md:mb-2">Primary Objective</div>
                  <div className="text-[9px] md:text-xs text-white/90 font-bold uppercase tracking-widest">Architectural Resilience</div>
               </div>
               <div className="p-3 md:p-4 border border-white/5 bg-white/5 rounded-xl backdrop-blur-sm">
                  <div className="font-mono text-[6px] md:text-[8px] text-cyan-500/60 uppercase mb-1 md:mb-2">Specialization</div>
                  <div className="text-[9px] md:text-xs text-white/90 font-bold uppercase tracking-widest">Neural Infrastructure</div>
               </div>
            </div>
          </div>
        </div>
